...
const ProfilePage: React.FC<ProfilePageProps> = ({
  ...
  const renderStatCard = (
    ...
    <div
      className={`p-4 rounded-xl border ${highlight ? "bg-sky-500/10 border-sky-500/30" : "bg-slate-800/50 border-slate-700/50"} flex flex-col`}
    >
      ...
      {subtext && (
        <span className="text-xs text-slate-500 mt-2">{subtext}</span>
      )}
    </div>
  );
  ...
  return (
    <div className="container mx-auto max-w-6xl px-4 pb-20">
      ...
      <div className="relative mb-16">
        ...
        <div className="bg-slate-800/40 backdrop-blur-md rounded-3xl border border-slate-700/50 p-8 lg:p-12 shadow-2xl relative overflow-hidden">
          {/* Background Glow */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7 flex flex-col md:flex-row items-start gap-8">
              <div className="relative flex-shrink-0">
                ...
                <button
                  ...
                  className="absolute bottom-2 right-2 p-2 bg-slate-800 text-sky-400 border border-slate-600 rounded-full hover:bg-slate-700 hover:text-white transition-all shadow-lg"
                  title="Edit Profile"
                >
              ...
              <div className="flex-1 space-y-4 pt-2">
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-slate-300">
                    <div className="flex items-center gap-1.5 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20">
                      ...
                      <span className="text-current/50 text-xs ml-1">
                        ({myRatings.length})
                      </span>
                    </div>
                ...
                <div className="flex gap-3 pt-2">
                  {currentUser.isAdmin && (
                    <span className="px-2 py-1 bg-indigo-500/20 text-indigo-300 text-xs rounded border border-indigo-500/30 uppercase font-bold tracking-wider">
                      Admin
                    </span>
                  )}
                </div>
            ...
            <div className="lg:col-span-5 h-full flex flex-col justify-center lg:border-l lg:border-slate-700/50 lg:pl-12">
              <div className="flex items-center gap-2 mb-8 text-slate-400 text-sm font-semibold uppercase tracking-wider">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {/* Reviews Card */}
                <div className="p-4 rounded-xl border bg-slate-800/50 border-slate-700/50 flex flex-col">
                  ...
                  <span className="text-xs text-amber-400 font-bold mt-2 flex items-center gap-1">
      ...
      <div className="bg-slate-800/40 backdrop-blur-md rounded-3xl border border-slate-700/50 p-8 lg:p-12 shadow-2xl relative overflow-hidden mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border border-emerald-500/20 p-6 rounded-2xl">
            <div className="text-emerald-400 font-bold text-3xl mb-1">
              +{currentMonthEarned}
            </div>
          ...
          <div className="bg-gradient-to-br from-sky-500/10 to-blue-500/5 border border-sky-500/20 p-6 rounded-2xl">
            <div className="text-sky-400 font-bold text-3xl mb-1">
          ...
          <div className="bg-slate-800/50 border border-slate-700 p-6 rounded-2xl flex flex-col justify-center">
            <div className="text-slate-200 font-semibold mb-1">Upcoming</div>
      ...
      <div className="bg-slate-800/40 backdrop-blur-md rounded-3xl border border-slate-700/50 p-8 lg:p-12 shadow-2xl relative overflow-hidden mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {currentUser.teaches.map((skill) => (
                <div
                  key={skill.id}
                  className="group relative flex items-center justify-between p-4 bg-slate-800/40 border border-slate-700 hover:border-sky-500/50 rounded-xl transition-all hover:bg-slate-800/80"
                >
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-lg bg-sky-500/10 flex items-center justify-center text-sky-400 group-hover:bg-sky-500 group-hover:text-white transition-all">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-semibold text-slate-300 flex items-center gap-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {currentUser.learns.length === 0 && (
                <div className="text-slate-500 italic w-full p-4">
      ...
      <div className="bg-slate-800/40 backdrop-blur-md rounded-3xl border border-slate-700/50 p-8 lg:p-12 shadow-2xl relative overflow-hidden mb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="text-center border-l border-slate-800">
            ...
            <div className="text-sm text-slate-400">Sessions Taught</div>
          </div>
          <div className="text-center border-l border-slate-800">
            <div className="text-4xl font-bold text-indigo-400 mb-2">
              {sessionsLearned}
            </div>
            <div className="text-sm text-slate-400">Sessions Learned</div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4 max-h-96 overflow-y-auto pr-2 custom-scrollbar">
          {filteredTransactions.length > 0 ? (
            filteredTransactions.map((transaction, idx) => (
              <div
                key={transaction.id}
                className="group flex items-center gap-6 p-4 rounded-xl hover:bg-slate-800/50 transition-colors border border-transparent hover:border-slate-800"
              >
                <div
                  className={`w-2 h-2 rounded-full ${transaction.type === "earned" ? "bg-emerald-500" : "bg-red-500"}`}
                />

                <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-slate-800 border border-slate-700 text-slate-400 group-hover:scale-105 transition-transform">
                ...
                <div
                  className={`text-right font-mono font-bold text-lg ${transaction.type === "earned" ? "text-emerald-400" : "text-slate-400"}`}
                >
                  {transaction.type === "earned" ? "+" : "-"}
                  {transaction.amount}
                </div>
