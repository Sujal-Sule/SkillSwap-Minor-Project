    ...
    <div className="space-y-6 mb-10">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-start">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          {/* Online Toggle */}
          <div className="bg-background p-1.5 rounded-xl border border-slate-200/10 dark:border-slate-800/10 flex shadow-[inset_2px_2px_5px_rgba(163,177,198,0.35),_inset_-2px_-2px_5px_rgba(255,255,255,0.85)] dark:shadow-[inset_2px_2px_5px_rgba(0,0,0,0.45),_inset_-2px_-2px_5px_rgba(255,255,255,0.02)]">
            <button
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="bg-background border border-slate-200/10 dark:border-slate-800/10 text-text-primary text-xs font-bold rounded-xl flex items-center justify-between py-3.5 px-5 min-w-[140px] outline-none transition-all cursor-pointer shadow-[3px_3px_8px_rgba(163,177,198,0.35),_-3px_-3px_8px_rgba(255,255,255,0.85)] dark:shadow-[3px_3px_8px_rgba(0,0,0,0.45),_-3px_-3px_8px_rgba(255,255,255,0.02)] hover:scale-[1.02] active:scale-95"
            >
              <span>{currentOption.label}</span>
              <svg
                className={`w-4 h-4 ml-2 text-text-muted transition-transform duration-300 ${isOpen ? "rotate-180" : ""}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
      ...
      {/* Categories Row */}
      <div className="flex flex-wrap gap-3.5 text-sm justify-center md:justify-start">
        <button
          onClick={() => setCategoryFilter(null)}
          className={`px-5 py-2.5 text-xs font-bold rounded-full transition-all duration-300 active:scale-95 ${
            !categoryFilter
